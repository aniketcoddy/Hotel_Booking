...
export default function Navbar(props) {
  return (
    <div>
      <div className={`fixed bg-[#F8e0a6]  w-full z-10 h-fit ${ props.open ? "translate-y-20" :"-translate-y-80"} ease-in-out duration-700` }>
      <ul className='top-0'>
      <Link spy={true} smooth={true} offset={-50} duration={1000}  to="Home"><li className="hover:bg-[#583101] hover:text-[#F8e0a6] text-[#583101]  text-xl font-[Poppins] p-2">Home</li></Link>
       <Link spy={true} smooth={true} offset={-50} duration={1000}  to="About"><li className="hover:bg-[#583101] hover:text-[#F8e0a6] text-[#583101]  text-xl font-[Poppins] p-2">About Us</li></Link>
